...
function printQuery (zvs, branchId, text) {
	const domains = zvs.branches.getDomains(branchId);
	const header = domains?domains.header:[];
	const values = domains?[...domains.values()]:[];

	const a = domains?[...domains.a.a.values()]:[];
	const b = domains?[...domains.a.b.values()]:[];
	const r = domains?[...domains.a.values()]:[];
	...
	console.log(
		...
		"json: " + JSON.stringify(domains?domains.toJSON():{}),
		"a: " + JSON.stringify(a),
		"b: " + JSON.stringify(b),
		"r: " + JSON.stringify(r),
		"name: " + (domains?domains.a.constructor.name:"")
	);
}
