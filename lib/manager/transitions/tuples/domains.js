    ...
    for (let i=0; i<branches.length; i++) {
        ...
        if (variables.length === 0 || bs.length === 1) {
            ...
            for (let i=0; i<bs.length; i++) {
                ...
                /**
                 * TODO: we also need to include domains [data] , on branch split, 
                 *       this is because domains have a tendacy to change because of forward updates.
                 *        
                 *       1. we need keep all domains sorted, so they can get same ids on data.
                 *       2. add it on branchSplit, ...
                 */
