...
class Table {
    ...
    addRowsABAB (ab, a, b) {
        /**
         * ab - distinct from each other
         * a - distinct from each other
         * b - disctinct from each other
         * 
         * a x ab - distinct from each other,
         * b x ab - distinct from each other,
         * 
         * a x b - cross product,
         */
        ...
        for (let i=0; i<ab.length; i++) {
            ...
            const alias = `a_${d.id}`;
            const s = new CSetArray(d.data).as(alias);

            sAB = sAB?sAB.crossProduct(s):s;

            for (let i=0; i<sABalias.length; i++) {
                const a = sABalias[i];

                sAB = sAB.select([a, alias], {
                    name: "<>",
                    predicate: (a, b) => a !== b
                });
            }
        ...
        this.s = sAB;
        this.header = sAB.header;
        
        console.log(sAB.header);
