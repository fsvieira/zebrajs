...
function toENE (header, s, max, i=1) {
...
class Table {
    ...
    toENE () {
        const ene = toENE(this.header, this.s, this.counter);

        console.log(this.counter);

        if (ene) {
            console.log(JSON.stringify(ene.solution), ene.solution.length, ene.count);

            console.log(this.s.count());
            this.s = ene.s;
        }
        else {
            console.log("ENE not found");
        }
    }
